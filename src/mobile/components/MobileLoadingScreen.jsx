    ...
    <div className={`fixed inset-0 bg-black z-[9999] flex flex-col items-center font-mono text-endfield-yellow safe-area-inset ${
      ...
      {stage === 'loading' && (
        <div className="relative z-10 flex flex-col items-center px-4">
          {/* 装饰性边角 */}
          <div className="fixed top-4 left-4 w-12 h-12 border-t-2 border-l-2 border-endfield-yellow/50 pointer-events-none" />
          <div className="fixed top-4 right-4 w-12 h-12 border-t-2 border-r-2 border-endfield-yellow/50 pointer-events-none" />
          <div className="fixed bottom-4 left-4 w-12 h-12 border-b-2 border-l-2 border-endfield-yellow/50 pointer-events-none" />
          <div className="fixed bottom-4 right-4 w-12 h-12 border-b-2 border-r-2 border-endfield-yellow/50 pointer-events-none" />
