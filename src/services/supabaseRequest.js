...
export const SUPABASE_READ_TIMEOUT_MS = import.meta.env.DEV ? DEV_READ_TIMEOUT_MS : PROD_READ_TIMEOUT_MS;
export const SUPABASE_RPC_TIMEOUT_MS = import.meta.env.DEV ? DEV_RPC_TIMEOUT_MS : PROD_RPC_TIMEOUT_MS;
export const SUPABASE_MUTATION_TIMEOUT_MS = import.meta.env.DEV ? DEV_MUTATION_TIMEOUT_MS : PROD_MUTATION_TIMEOUT_MS;
